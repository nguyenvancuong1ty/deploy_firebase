...
// update();
const getAllAccount = () => __awaiter(void 0, void 0, void 0, function* () {
    const accountRef = firebase_1.db.collection('products');
    const querySnapshot = yield accountRef.get();
    const response = querySnapshot.docs.map((doc) => __awaiter(void 0, void 0, void 0, function* () {
        const data = doc.data();
...
const user = [
    ...
    },
    {
        ...
        tokenNotify: 'cSFPjtQeyo8YB1Gv2VhUMf:APA91bFAg5siBquqwY9tzlIYx1aK1soKAMtnJp9yigTCkuc1Bs9V_f4-wn9GhLIDrjfot2btpgaVDoeAzxgOVj7pk9VXiMOkXAhapoaL4FPy9RNKwcvL2lqy_NSQVOA51WU3maVcDsEY',
    },
    {
        ...
        type_account: 'admin',
        tokenNotify: 'dzs_-q9xvavV3ZvPwD6ZWe:APA91bELGR7DKUK-xUYK1fSF3Adzbpe5s4joDC9nI7GCIRljYqrSZPfqpj8cqrAYhmxk8g1Ckk8gltEcviSGjitIOrHFK-O1cg1UG7hiwEkqnSH2UFylRN_Hf32AXV-UeyHMCKA6KnNv',
    },
    {
